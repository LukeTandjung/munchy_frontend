          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'By creating an account, I agree to the terms and service, payment terms, and privacy terms.',
                  style: TextStyle(
                    fontSize: 12,
                ...
                Center(
                  child: SliderButton(
                    action: () async {
                      ...
                      try {
                        // Provider.of<User>(context, listen: false).registerUser(
                        //     Provider.of<User>(context, listen: false).email,
                        //     Provider.of<User>(context, listen: false).password
                        // );
                        Navigator.pushNamed(context, OnboardName.id);
                        setState(() {
